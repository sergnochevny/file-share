<div class="layout-header">
    <div class="navbar navbar-default">
        <div class="navbar-header">
            <a class="navbar-brand navbar-brand-center" href="index.php" title="Plan. Protect. Prosper.">
                <img class="navbar-brand-logo" src="images/logo.png" alt="Plan. Protect. Prosper.">
            </a>
                    ...
                    <li class="hidden-xs hidden-sm">
                        <form class="navbar-search navbar-search-collapsed">
                            <div class="navbar-search-group">
                                <input class="navbar-search-input" type="text" placeholder="Search for people, companies">
                            ...
                            <div class="dropdown-body">
                                <div class="list-group list-group-divided custom-scrollbar">
                                    <a class="list-group-item" href="messenger.php">
                                        <div class="notification">
                                            <div class="notification-media">
                                                <img class="rounded" width="40" height="40" src="images/users/photo/1.jpg" alt="Harry Jones">
                                            </div>
                                            <div class="notification-content">
                                                <small class="notification-timestamp">16 min</small>
                                                <h5 class="notification-heading">Harry Jones</h5>
                                                <p class="notification-text">
                                                    <small class="truncate">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</small>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="list-group-item" href="messenger.php">
                                        <div class="notification">
                                            <div class="notification-media">
                                                <img class="rounded" width="40" height="40" src="images/users/photo/2.jpg" alt="Daniel Taylor">
                                            </div>
                                            <div class="notification-content">
                                    ...
                                    <a class="list-group-item" href="messenger.php">
                                        <div class="notification">
                                            <div class="notification-media">
                                                <img class="rounded" width="40" height="40" src="images/users/photo/3.jpg" alt="Charlotte Harrison">
                                            </div>
                                            <div class="notification-content">
                                    ...
                                    <a class="list-group-item" href="#">
                                        <div class="notification">
                                            ...
                                            <div class="notification-content">
                                                ...
                                                <p class="notification-text">
                                                    <small class="truncate">Project <b>Ethan Walker</b> moved to the archive</small>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="list-group-item" href="#">
                                        <div class="notification">
                                            ...
                                            <div class="notification-content">
                                                ...
                                                <p class="notification-text">
                                                    <small class="truncate">Added new user: <b>Charlotte Harrison</b></small>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="list-group-item" href="#">
                                        <div class="notification">
                                            ...
                                            <div class="notification-content">
                                                ...
                                                <h5 class="notification-heading">Moving to archive</h5>
                                                <p class="notification-text">
                                                    <small class="truncate">Project <b>Sophia Evans</b> moved to the archive</small>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
