...
!function (a) {
    var b = {
        Constants: {
            ...
            SHARE_MESSAGE_EXTENDED_TIME_OUT: 5e3,
            SHARE_MESSAGE_KEY: "share_message",
            SHARE_MESSAGE_PROGRESS_BAR: !0,
            SHARE_MESSAGE_STATUS: !0,
            SHARE_MESSAGE_TIME_OUT: 15e3,
        ...
        expandSidenav: function () {
            ...
            this.$layout.removeClass(this.CssClasses.LAYOUT_SIDEBAR_COLLAPSED), this.$sidenav.trigger(b).hide(), this.$sidenav.removeClass(this.CssClasses.SIDENAV_COLLAPSED), this.$sidenavBtn.removeClass(this.CssClasses.COLLAPSED), this.transitionTimeoutId && clearTimeout(this.transitionTimeoutId), this.transitionTimeoutId = setTimeout(function () {
        ...
        isShareMessageShown: function () {
            return !!Cookies.get(this.Constants.SHARE_MESSAGE_KEY)
        },
        setShareMessageShown: function () {
            var a, b, c = {};
            a = this.Constants.SHARE_MESSAGE_KEY, b = this.Constants.SHARE_MESSAGE_STATUS, c.expires = this.Constants.SHARE_MESSAGE_EXPIRES, Cookies.set(a, b, c)
        },
        showShareMessage: function () {
            var a, b, c;
            this.isShareMessageShown() || (c = this.getShareMessageOptions(), b = "If you like Elephant, please share it with your friends and followers, this way you will help the elephant grow.", toastr.info(b, a, c), this.setShareMessageShown())
        },
        ...
        setSidebarFixed: function (a) {
            var b = {}, c = this.getSidebarScrollableArea();
        ...
        createStickySidebar: function () {
            var a = this.getSidebarScrollableArea(), b = this.getStickyOptions();
        ...
        getCreateOptions: function (b, c) {
            var d = new RegExp("^" + b + "(_)?", "i"), e = {};
            return a.each(this, function (b, f) {
                a.isPlainObject(f) && a.each(f, function (f, g) {
                    d.test(f) && (f = f.replace(d, "").replace(/_/g, "-"), f = a.camelCase(f.toLowerCase()), c && c(e, b, f, g) || (e[f] = g))
                })
            }), e
        },
        getShareMessageOptions: function () {
        ...
        getCustomScrollbarOptions: function () {
            ...
            return this.getCreateOptions("custom_scrollbar", a)
        },
        ...
        getSidenavOptions: function () {
            ...
            return this.getCreateOptions("sidenav", a)
        },
        getStickyOptions: function () {
            var a = function (a, b, c, d) {
                return c = "CssClasses" === b ? c + "ClassName" : c, a[c] = d
            };
            return this.getCreateOptions("sticky", a)
        },
        ...
        initPeity: function () {
            a("[data-peity]").each(function () {
                var b = a(this).data(), c = a.camelCase(b.peity);
                a(this).peity(c, b)
            })
        },
        ...
        select2: function () {
            var b = a.fn.select2, c = this.getSelect2Options();
