...
!function (a) {
    function b() {
        ...
        b.waypoint({
            handler: function (b) {
                var c = a(this.element), d = ["animated", "bounceInUp"];
                if ("up" !== b) {
                    c.addClass(d.join(" "));
                    var e = function () {
    ...
    function c() {
        ...
        b = a("#demo-show-toast"), b.on("click", function (b) {
            ...
            a(":input").each(function (b) {
                var d = a(this), e = d.attr("id"), f = d.val();
                d.is("input[type='checkbox']") && (f = d.prop("checked")), e && f && (c[e] = f)
            });
            var e = c.title || "", f = c.message || d[Math.floor(Math.random() * d.length)];
            toastr[c.type](f, e, c)
    ...
    function e() {
        ...
        // b.bootstrapWizard({nextSelector: ".btn-next", tabClass: "steps"})
    }
    ...
    function f() {
        ...
        // b.bootstrapWizard({
        //     nextSelector: ".btn-next", tabClass: "steps", onNext: function (a, c, d) {
        //         return b.valid()
    ...
    function h() {
        var b = a("#demo-datepicker-1"), c = a("#demo-datepicker-1-btn");
        b.datepicker({autoclose: !0, orientation: "top right", showOnFocus: !1}), c.on("click", function (a) {
            b.datepicker("show")
        })
    }

    function i() {
        var b = a("#demo-datepicker-2"), c = a("#demo-datepicker-2-btn");
        b.datepicker({autoclose: !0, orientation: "top left", showOnFocus: !1}), c.on("click", function (a) {
            b.datepicker("show")
        })
    }
    ...
    function k() {
        var b = a("#demo-timepicker-2"), c = a("#demo-timepicker-2-btn");
    ...
    function l() {
        var b = a("#demo-timepicker-3"), c = b.find(".time");
        c.timepicker({showDuration: !0, timeFormat: "g:ia"}), b.datepair()
    }

    function m() {
        var b = a("#demo-timepicker-4");
        b.timepicker({disableTimeRanges: [["12am", "9am"], ["6:01pm", "11:31pm"]]})
    }

    function n(b) {
        var c = a("#demo-timepicker-5");
        c.timepicker({timeFormat: "H:i:s"})
    }

    function o() {
        var b = a("#demo-timepicker-6"), c = b.find(".time"), d = b.find(".date");
        c.timepicker({showDuration: !0, timeFormat: "g:ia"}), d.datepicker({
            format: "MM d, yyyy",
            autoclose: !0
        }), b.datepair()
    }
    ...
    function p(b) {
        ...
        c.timepicker({noneOption: [{label: "Board meeting", className: "ui-timepicker-pm", value: "6:00pm"}]})
    }

    function q() {
        var b = a("#demo-timepicker-8");
        b.timepicker({step: 15})
    }
    ...
    function rr() {
        var b = a("#demo-select2-1-2");
        b.select2()
    }

    function rrr() {
        var b = a("#demo-select2-1-3");
        b.select2()
    }

    function rrrr() {
        var b = a("#demo-select2-1-4");
        b.select2()
    }
    ...
    function t() {
        ...
        b.select2({tags: !0, tokenSeparators: [",", " "]})
    }

    function u() {
        var b = a("#demo-select2-4");
        b.select2({templateResult: w, templateSelection: w})
    }

    function v() {
        var b = a("#demo-select2-5"), c = a("#demo-select2-5-input");
        b.select2({templateResult: w, templateSelection: w}), b.on("change", function (b) {
    ...
    function w(b) {
        ...
        var g = a("<span/>", {text: d});
        return a("<img>", {class: "img-flag", src: f}).prependTo(g), g
    }
    ...
    function x() {
        ...
        b.slider({
            ...
            start: 5,
            step: 5,
            tooltips: [wNumb({decimals: 2, prefix: "$"})],
            pips: {
                mode: "steps", filter: function (a, b) {
                    return a % 10 ? 2 : 1
    ...
    function y() {
        var b = a("#demo-slider-2"), c = a("#demo-slider-2-img");
        b.slider({
            direction: "rtl",
            ...
            range: {min: 0, "20%": 50, "40%": 100, "60%": 150, "80%": 200, max: 250},
            pips: {
                mode: "steps", filter: function (a, b) {
                    return a % 100 ? 2 : 1
    ...
    function z() {
        ...
        b.fileupload({autoUpload: !0, filesContainer: ".file-list"})
    }
    ...
    function A() {
        ...
        b.length && (b.bootstrapTable({
            columns: [{field: "name", title: "Name"}, {
                field: "position",
                title: "Position"
            }, {field: "salary", title: "Salary"}], height: 265, url: "/employees.json"
    ...
    function B() {
        ...
        b.length && (b.bootstrapTable({
            columns: [{align: "left", field: "name", title: "Name"}, {
                align: "center",
                field: "position",
                title: "Position"
            }, {align: "right", field: "salary", title: "Salary"}], height: 265, url: "/employees.json"
        }), a(window).on("resize", function (a) {
            b.bootstrapTable("resetView")
        }))
    }
    ...
    function C() {
        ...
        b.length && (b.bootstrapTable({
            columns: [{align: "left", field: "name", title: "Name"}, {
                ...
                field: "position",
                title: "Position"
            }, {align: "right", field: "salary", title: "Salary"}], height: 265, striped: !0, url: "/employees.json"
        }), a(window).on("resize", function (a) {
            b.bootstrapTable("resetView")
        }))
    }
    ...
    function D(a, b) {
        var c = ["active", "success", "info", "warning", "danger"], d = b % 2 === 0 ? c[b % 10 / 2] : "";
        return {classes: d}
    }
    ...
    function E() {
        ...
        b.length && (b.bootstrapTable({
            columns: [{align: "left", field: "name", title: "Name"}, {
                ...
                field: "position",
                title: "Position"
            }, {align: "right", field: "salary", title: "Salary"}], height: 265, rowStyle: D, url: "/employees.json"
        }), a(window).on("resize", function (a) {
            b.bootstrapTable("resetView")
        }))
    }
    ...
    function G() {
        ...
        b.length && (b.bootstrapTable({
            columns: [{field: "state", formatter: F}, {
                field: "name",
                title: "Name"
            }, {field: "position", title: "Position"}], height: 265, url: "/employees.json"
        }), a(window).on("resize", function (a) {
            b.bootstrapTable("resetView")
        }))
    }
    ...
    function I() {
        ...
        b.length && (b.bootstrapTable({
            classes: "table",
            columns: [{field: "name", title: "Name"}, {field: "position", title: "Position"}, {
                field: "state",
                formatter: H
            }],
            height: 265,
    ...
    function L() {
        ...
        b.bootstrapTable({
            columns: [{align: "right", field: "rank", sortable: !1, title: "Rank"}, {
                align: "left",
                field: "country",
                formatter: J,
                sortable: !1,
                title: "Country"
            }, {align: "right", field: "continent", sortable: !0, title: "Continent"}, {
                align: "right",
                field: "region",
                sortable: !0,
                title: "Region"
            }, {align: "right", field: "year2016", sortable: !0, sorter: K, title: "2016"}, {
                align: "right",
                field: "year2015",
                sortable: !0,
                sorter: K,
                title: "2015"
            }, {align: "right", field: "change", sortable: !0, sorter: K, title: "Change"}],
            height: 411,
            striped: !0,
            url: "/population.json"
        }), a(window).on("resize", function (a) {
    ...
    function P() {
        ...
        if (b.length) {
            ...
            a.extend(!0, c.ext.classes, {sWrapper: "dataTables_wrapper dt-bootstrap"}), a("#demo-datatables-3 tfoot th").each(function () {
                var b = a(this).text();
    ...
    function Q() {
        ...
        if (b.length) {
            var c = a.fn.dataTable;
            a.extend(!0, c.ext.classes, {sWrapper: "dataTables_wrapper dt-bootstrap"}), b.DataTable({
                dom: "<'row'<'col-sm-12'i>><'table-responsive'tr><'row'<'col-sm-6'l><'col-sm-6'p>>",
                language: {paginate: {previous: "&laquo;", next: "&raquo;"}},
                initComplete: function () {
                    this.api().columns().every(function () {
                        var b = this, c = b.header(), d = a('<select class="demo-select2"><option value="">' + a(c).text() + "</option></select>").appendTo(a(b.footer()).empty()).on("change", function () {
    ...
    function S() {
        ...
        a.extend(!0, b.Buttons.defaults, {dom: {button: {className: "btn btn-primary btn-sm"}}});
    ...
    function T() {
        var b = a.fn.dataTable;
        a.extend(!0, b.Buttons.defaults, {dom: {button: {className: "btn btn-outline-primary btn-sm"}}});
    ...
    function ZZ() {
        var b = a("#demo-datatables-responsive-modal");
        b.DataTable({
            responsive: !0,
            "aoColumnDefs":[{
                "aTargets": [ 5 ]
    ...
    function ca() {
        var b = a("#demo-map-1");
        b.length && new GMaps({div: b[0], height: "300px", lat: 37.77, lng: -122.447, zoom: 12})
    }

    function da() {
        var b = a("#demo-map-2");
        if (b.length) {
            var c = new GMaps({div: b[0], height: "300px", lat: 37.77, lng: -122.447, zoom: 11});
            c.addMarker({
    ...
    function ea() {
        ...
        if (b.length) {
            ...
            c.drawPolyline({path: d, strokeColor: "#ff0000", strokeOpacity: 1, strokeWeight: 3})
        }
    }
    ...
    function ga() {
        var b = a("#demo-map-5");
        if (b.length) {
            var c = new GMaps({div: b[0], height: "300px", lat: 37.76904, lng: -122.483519, zoom: 12});
            c.drawRoute({
    ...
    function ha() {
        var b = a("#demo-map-6"), c = a("#demo-map-6-btn");
        if (b.length) {
            var d = new GMaps({div: b[0], height: "300px", lat: 37.76904, lng: -122.483519, zoom: 12});
    ...
    function ia() {
        ...
        if (b.length) {
            var c = new GMaps({
                ...
                lng: -122.447,
                zoom: 12,
                mapTypeControlOptions: {mapTypeIds: ["hybrid", "osm", "roadmap", "satellite", "terrain"]}
            });
            c.addMapType("osm", {
                getTileUrl: function (a, b) {
                    return "https://a.tile.openstreetmap.org/" + b + "/" + a.x + "/" + a.y + ".png"
                }, maxZoom: 18, name: "OpenStreetMap", tileSize: new google.maps.Size(256, 256)
            }), c.setMapTypeId("osm")
        }
    }
    ...
    function ja() {
        ...
        b = a("#demo-chart-1"), b.length && (f = ["Cellphones", "Accessories", "Cameras", "Computers", "Tablets", "Vehicle Electronics", "Video Games", "TV", "Audio", "Surveillance"], g = function () {
            ...
            options: {
                ...
                scales: {
                    xAxes: [{
                        scaleLabel: {display: !0, labelString: "The difference with the previous year."},
                        ticks: {
                    ...
                    yAxes: [{
                        scaleLabel: {display: !0, labelString: "This Year Electronic Sales"},
                        ticks: {
                            userCallback: function (a) {
                ...
                tooltips: {
                    callbacks: {
                        label: function (a, b) {
                            var c = b.datasets[a.datasetIndex].label, d = b.datasets[a.datasetIndex].data[a.index];
            ...
            var c, d;
            c = {}, d = qa(1), c.label = b, c.borderColor = d, c.backgroundColor = d, c.pointBorderColor = d, c.pointBackgroundColor = d, c.pointBorderWidth = 1, c.data = [{
                x: h(),
                y: g(),
                r: i()
        ...
        b = a("#demo-chart-2"), b.length && (d = ["January", "February", "March", "April", "May", "June", "July"], e = ["Questions", "Incidents", "Problems", "Tasks"], f = function () {
            ...
            options: {
                ...
                scales: {
                    ...
                    yAxes: [{display: !0, scaleLabel: {display: !0, labelString: "Number of tickets"}}]
                },
                title: {display: !0, text: "Monthly Report"}
            }
        }, a.each(e, function (b, e) {
            var h, i, j, k;
            h = [], i = [], a.each(d, function (a, b) {
                h.push(f()), i.push(g())
            }), j = qa(.5), k = {}, k.backgroundColor = j, k.borderColor = j, k.data = h, k.fill = !1, k.label = e, k.pointBackgroundColor = j, k.pointBorderColor = j, k.pointBorderWidth = 1, k.pointHoverRadius = i, k.pointRadius = i, b % 2 == 0 && (k.borderDash = [5, 5]), c.data.datasets.push(k)
        }), new Chart(b, c))
    }
        ...
        b = a("#demo-chart-3"), b.length && (c = function () {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    label: "Dataset 1",
                    type: "bar"
                }, {data: [c(), c(), c(), c(), c(), c(), c()], label: "Dataset 2", type: "bar"}, {
                    borderDash: [5, 5],
                    data: [c(), c(), c(), c(), c(), c(), c()],
                    fill: !1,
                    label: "Dataset 3",
            ...
            options: {
                maintainAspectRatio: !1,
                title: {display: !0, text: "Bar Line Combination Chart"},
                animation: {
                    onComplete: function () {
                        var a = this.chart, b = a.ctx;
    ...
    function na(b) {
        var c = a("#demo-peity-chart");
        c.length && (c.peity("line", {width: 64}), setInterval(function () {
            var a = Math.round(10 * Math.random()), b = c.text().split(",");
            b.shift(), b.push(a), c.text(b.join(",")).change()
        }, 1e3))
    }
    ...
    var oa = function (a, b) {
        ...
        return Math.round(oa(a, b))
    }, qa = function (a) {
        var b = [];
        return b.push(pa(0, 255)), b.push(pa(0, 255)), b.push(pa(0, 255)), b.push(a || "0.3"), "rgba(" + b.toString() + ")"
    };
    companyList(), b(), c(), d(), e(), f(), g(), h(), i(), j(), k(), l(), m(), n(), o(), p(), q(), r(), rr(), rrr(), rrrr(), s(), t(), u(), v(), x(), y(), z(), A(), B(), C(), E(), G(), I(), L(), M(), N(), O(), P(), Q(), R(), S(), T(), U(), V(), W(), X(), Y(), Z(), ZZ(),filelist(), $(), _(), aa(), ba(), ca(), da(), ea(), fa(), ga(), ha(), ia(), ja(), ka(), la(), ma(), na()
}(jQuery);