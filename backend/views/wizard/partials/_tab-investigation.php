...
<div id="tab-3" class="tab-pane active">
    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($investigationForm, 'first_name')->textInput([
                'tabindex' => 1,
                'placeholder' => 'Name',
                'maxlength' => true
            ]) ?>
            <?= $form->field($investigationForm, 'middle_name')->textInput([
                'tabindex' => 2,
                'placeholder' => 'Name',
                'maxlength' => true
            ]) ?>
            <?= $form->field($investigationForm, 'last_name')->textInput([
                'tabindex' => 3,
                'placeholder' => 'Name',
                'maxlength' => true
            ]) ?>
        ...
        <div class="col-sm-6">
            ...
            <?= $form->field($investigationForm, 'birthDate')->widget(MaskedInput::className(), [
                'clientOptions' => ['alias' => 'mm/dd/yyyy', 'yearrange' => ['minyear' => 1920, 'maxyear' => 2000],],
    ...
    <div class="row">
        ...
        <div align="center">
            <?php if ($isDbHasCompany): ?>
                <button tabindex="<?= ($typesCount + 7) ?>" id="company-create"
                        class="btn btn-sm btn-labeled  arrow-warning" type="submit">
